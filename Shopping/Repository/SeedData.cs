...
namespace Shopping.Repository
{
	public class SeedData
	{
		public static void SeedingData(DataContext _context)
		{
			...
			{
				CategoryModel mackbook = new CategoryModel{ Name="Mackbook",Slug="macbook",Description="Macbook is Large Product in the world",Status=1};
				...
				_context.Products.AddRange(
					new ProductModel { Name = "Macbook", Slug = "macbook", Description = "Macbook is Best", Image = "1.jpg", Category = mackbook, Brand = apple, Price = 1233 },
